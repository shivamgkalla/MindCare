...
class JournalBase(BaseModel):
    ...
    mood: Optional[str] = Field(None, example=["very happy", "happy", "neutral", "sad"], description="User's mood while writing the journal") 
...
class JournalUpdate(BaseModel):
    ...
    mood: Optional[str] = Field(None, example=["very happy", "happy", "neutral", "sad"])
